...
public class DataBase {
    ...
    static {
        customerDataTable.add(new Customer("C001","Rushain","Colombo",2500));
        customerDataTable.add(new Customer("C002","Sayu","Dehiwala",1500));
        customerDataTable.add(new Customer("C003","Naruto","Tokiyo",2500));
